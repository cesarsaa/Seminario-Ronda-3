...
El análisis de imágenes es el proceso de segmentación de imágenes en diferentes categorías en función de su fe a ras. Una característica podría ser:

+ Los bordes de una imagen

- La intensidad de los píxeles

+ El cambio en los valores de los píxeles

- etc. 

El mayor desafío al trabajar con imágenes es la incertidumbre de estas características. Para el ojo humano, parece igual, sin embargo, cuando se convierte en datos, es posible que no encuentre fácilmente un patrón específico en estas imágenes.
